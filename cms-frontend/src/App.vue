...
:root {
  ...
  --el-color-primary-light-3: #5a93d0;
  --el-color-primary-light-5: #89b5e1;
  --el-color-primary-light-7: #b8d3ef;
  --el-color-primary-light-8: #d6e8ff;
  --el-color-primary-light-9: #ebf4fb;
